...
│   ├── codebase_rag.py      # Semantic search with local embeddings (v2.6.9)
...
### Codebase RAG (src/codebase_rag.py) (v2.6.9)
...
### Tool Calling Framework (src/tool_framework.py) (v2.6.9)
...
### Plugin System (src/plugin_system.py) (v2.6.9)
...
### DevOps Agent (src/orchestrator.py) (v2.6.9)
...
### Security Agent (src/orchestrator.py) (v2.6.9)
...
### Screen Capture / Vision Analysis (src/screen_capture.py) (v2.6.9)
...
### Browser Automation (src/browser_agent.py) (v2.6.9)
...
### Persistent Long-Term Memory (src/long_term_memory.py) (v2.6.9)
...
### MCP Integration (src/mcp_client.py) (v2.6.9)
...
### A2A Protocol (src/a2a_protocol.py) (v2.6.9)
