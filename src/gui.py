...
class CrackedCodeGUI(QMainWindow):
    def __init__(self):
        ...
        logger.info("CrackedCode GUI v2.9.2 started")
    ...
    def setup_atlan_theme(self):
        self.setWindowTitle("CRACKEDCODE v2.9.2 // AUTONOMOUS NEURAL SYSTEM")
    ...
    def show_about(self):
        ...
        subtitle = QLabel("AUTONOMOUS NEURAL SYSTEM v2.9.2")
