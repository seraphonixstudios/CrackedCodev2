...
<p align="center">
  <img src="https://img.shields.io/badge/Version-2.7.3-blue?style=for-the-badge" alt="Version">
...
| Version | Features |
|---------|----------|
| 2.7.3 | **Multi-Model Auto-Routing** - Intent-based model selection (qwen3/dolphin/llava) |
| 2.7.3 | **Security Agent** - 11th agent role with vulnerability scanning, secret audit, permission check |
| 2.7.3 | **Browser Automation** - Playwright-based web agent with 6 tools |
| 2.7.3 | **Persistent Long-Term Memory** - Vector store of conversations, decisions, errors, fixes |
| 2.7.3 | **A2A Protocol** - Google's Agent-to-Agent protocol for multi-agent communication |
| 2.7.3 | **MCP Integration** - Model Context Protocol for external tool servers |
| 2.7.3 | **Screen Capture / Vision** - AI-powered screen understanding with llava:13b-gpu |
| 2.7.3 | **DevOps Agent** - 10th agent role with Docker, deploy, CI tools |
| 2.7.3 | **Plugin System** - Extensible hooks with hot-reload |
| 2.7.3 | **Tool Calling Framework** - ReAct loop with 36+ tools |
| 2.7.3 | **Codebase RAG** - Semantic search with local embeddings |
| 2.7.3 | **Agent Reasoning Engine** - Thought chains, coherence tracking, LLM meta-reasoning |
...
## Multi-Model Auto-Routing (v2.7.3)
...
## Screen Capture / Vision Analysis (v2.7.3)
...
## Persistent Long-Term Memory (v2.7.3)
...
<p align="center">
  <strong>CrackedCode v2.7.3</strong> — Neural Coding Interface
</p>
