"""Agent Collaboration / Multi-Agent Chat v2.10.0 - Multi-agent debate and consensus.
...
class AgentParliament:
    ...
    PERSONAS = {
        "architect": AgentPersona(
            ...
            system_prompt="You are a software architect. Focus on design patterns, scalability, and maintainability.",
        ),
        "security": AgentPersona(
            name="Security", role="security",
            expertise=["vulnerabilities", "auth", "pentest"],
            communication_style="cautious",
            priorities=["security", "privacy", "compliance"],
            system_prompt="You are a security engineer. Identify vulnerabilities, attack vectors, and compliance issues.",
        ),
        "coder": AgentPersona(
            name="Coder", role="coder",
            expertise=["implementation", "refactoring", "performance"],
            communication_style="pragmatic",
            priorities=["performance", "readability", "test coverage"],
            system_prompt="You are a senior developer. Focus on clean code, performance, and testability.",
        ),
        "reviewer": AgentPersona(
            ...
            system_prompt="You are a code reviewer. Check for best practices, standards compliance, and clarity.",
        ),
        "devops": AgentPersona(
            name="DevOps", role="devops",
            expertise=["deployment", "ci/cd", "containers"],
            communication_style="operational",
            priorities=["reliability", "automation", "observability"],
            system_prompt="You are a DevOps engineer. Consider deployment, CI/CD, monitoring, and operational concerns.",
        ),
        "tester": AgentPersona(
            name="Tester", role="tester",
            expertise=["testing", "qa", "edge cases"],
            communication_style="meticulous",
            priorities=["coverage", "reliability", "edge cases"],
            system_prompt="You are a QA engineer. Identify test scenarios, edge cases, and regression risks.",
        ),
    }
